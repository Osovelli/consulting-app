  ...
  return (
    <div className="w-full max-w-md mx-auto mt-6 bg-white shadow-sm">
      <div className="flex justify-between items-center p-4 bg-gray-100">
        <h2 className="text-lg font-semibold capitalize">Service details</h2>
      </div>
      <div className="p-4 space-y-6">
          <div className="space-y-4">
            <div className=" border-b-2 pb-2">
              <h4 className="text-xs font-medium text-[#868C98] uppercase">Service ID</h4>
              <p className="text-sm font-medium">{data.id}</p>
            </div>
            <div className=" border-b-2 pb-2">
              <h4 className="text-xs font-medium text-[#868C98] uppercase">Service name</h4>
              <p className="text-sm font-medium">{data.serviceName}</p>
            </div>
            <div className=" border-b-2 pb-2">
              <h4 className="text-xs font-medium text-[#868C98] uppercase">Service Cost</h4>
              <p className="text-sm font-medium">{data.cost}</p>
            </div>
            <div className=" border-b-2 pb-2">
              <h4 className="text-xs font-medium text-[#868C98] uppercase">Service Description</h4>
              <div className="flex flex-wrap items-center sm:gap-2">
                <p className="text-sm font-medium">{data.shortDesc}</p>
