    ...
    return(
        <div className="w-full rounded-lg my-6">
            <div className="flex justify-between items-center p-4 bg-gray-100">
                <h2 className="text-lg font-semibold capitalize">Create Service</h2>
            </div>
            <form onSubmit={onSubmit} className="space-y-6 p-4">
                <div className=" space-y-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <Input type="number" placeholder="Service cost" className="rounded-r-none " />
                    </div>
                    <div className="space-y-1">
                        <Label>Service Description</Label>
                        <Textarea rows={6} placeholder="Service description..." className="rounded-r-none " />
                    </div>
                </div>
                {showError && (
                ...
                <div className="flex gap-1 justify-between">
                    <Button className='w-full' type="button" variant="outline" onClick={() => {}}>Cancel</Button>
