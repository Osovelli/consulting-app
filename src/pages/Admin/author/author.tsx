...
import { authorsData as Data } from '../../Components/mock/blog-data'
  ...
  useEffect(() => {
    ...
    return(
      ...
      <header className='flex justify-between'>
        <div>
          <h2 className='text-lg font-medium'>Blog Author</h2>
          <p className='text-sm font-normal'>
            Create and manage your blog authors here.
          </p>
        </div>
      ...
      <AuthorMenu isOpen={sideMenuOpen} content={sideMenuContent} onClose={handlesideClose} data={selectedService}  />
    </div>
    )
  }