    ...
    <div className="container mx-auto p-4 relative">
      <div className="flex items-center gap-4 justify-between mb-6">
        <div className="flex items-center">
          <ArrowLeft className="mr-2" onClick={onClose} />
          <h1 className="text-xl font-semibold">{application.applicationId}</h1>
        </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <Badge variant="outline" className="bg-yellow-50 text-yellow-700 border-yellow-300">{application.status}</Badge>
              </div>
              <div className="flex justify-between">
      ...
      <ConfirmModal
        ...
        approvalNumber={application.applicationId}
      />
    </div>
  )
}